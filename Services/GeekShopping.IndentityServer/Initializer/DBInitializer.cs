    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                Email = "roberto-admin@roberto.com.br",
                EmailConfirmed = true,
            ...
            _user.CreateAsync(admin, "Roberto123$").GetAwaiter().GetResult();
            ...
            ApplicationUser client = new ApplicationUser()
            {
                ...
                Email = "roberto-client@roberto.com.br",
                EmailConfirmed = true,
                PhoneNumber = "+55 (34) 12345-6789",
                FirstName = "roberto",
                LastName = "Client"
            ...
            _user.CreateAsync(client, "Roberto123$").GetAwaiter().GetResult();
